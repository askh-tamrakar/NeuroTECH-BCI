            ...
            <span className="flex flex-row justify-between">
                ...
                <span className="flex bg-[var(--surface)] rounded-lg p-1 border border-[var(--border)]">
                    ...
                    <button
                        ...
                        className={`px-2 py-1.5 rounded-md text-sm font-medium transition-all ${activeTab === 'EEG' ? 'bg-[var(--primary)] text-white shadow' : 'text-[var(--text)] hover:text-[var(--primary)]'} `}
                    >
...
export default function MLTrainingView() {
    ...
    const [params, setParams] = useState({
        ...
        EEG: { n_estimators: 100, max_depth: 6, test_size: 0.2 }
    });
