        ...
        if (worker) {
            worker.onmessage = (e) => {
                ...
                if (type === 'GAME_OVER') {
                    ...
                    const count = e.data.obstaclesPassed || 0;
                    setCactusJump(count);

                    setBestCactusJump(prev => {
                        if (count > prev) {
                            localStorage.setItem('dino_best_cactus', count.toString());
                            return count;
                        }
                        return prev;
                    });
        ...
        <div className="dino-container">
                    ...
                    <div className="game-card">
                        <div className="game-header">
                            ...
                            <h2 className="game-title">
                                <span className={`status-eye ${isConnected ? 'connected' : 'disconnected'}`}><ScanEye size={24} /></span>
                                EOG Dino Game
                            </h2>
                        </div>

                        <div className="game-content-stack relative h-full flex flex-col">
                            <div className="game-info-panel">
                                ...
                                <div className="eyes-container">
                                    ...
                                    <svg className="face-decoration-svg" style={{ overflow: 'visible', width: '100%', height: '100%' }}>
                                        ...
                                        <path
                                            d="M -120 -12 A 48 48 0 0 1 -72 -46"
                                            fill="none"
                                            stroke="var(--text)"
                                            strokeWidth="2"
                                            strokeLinecap="round"
                                        ...
                                        <path
                                            d="M 120 -12 A 48 48 0 0 0 72 -46"
                                            fill="none"
                                            stroke="var(--text)"
                                            strokeWidth="2"
                                            strokeLinecap="round"
                                ...
                                <div className="game-stats-container">
                                    ...
                                    <div className="stat-group-status">
                                        <div className="stat-block-column">
                                            <span className="stat-label flex items-center gap-2">
                                                <Activity size={18} className="text-primary" /> STATUS
                                            </span>
                                    ...
                                    <div className="stat-group-center">
                                        <div className="stat-row-centered">
                                            <Counter value={cactusJump} fontSize="1.3rem" places={[100, 10, 1]} className="stat-counter-primary-light" style={{ lineHeight: 1 }} />
                                            <TreePine size={22} className="text-primary/40 mx-2" />
                                            <Counter value={bestCactusJump} fontSize="1.3rem" places={[100, 10, 1]} className="stat-counter-primary-light" style={{ lineHeight: 1 }} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="stat-group-center">
                                        <div className="stat-row-centered">
                                            <Counter value={Math.floor(score / 10)} fontSize="1.3rem" places={[10000, 1000, 100, 10, 1]} className="stat-counter-primary-light" style={{ lineHeight: 1 }} />
                                            <Target size={22} className="text-primary/40 mx-2" />
                                            <Counter value={Math.floor(highScore / 10)} fontSize="1.3rem" places={[10000, 1000, 100, 10, 1]} className="stat-counter-primary-light" style={{ lineHeight: 1 }} />
                                        </div>
                                    </div>

                                    {/* Far Right: Sensor Status */}
                                    <div className="stat-group-sensor">
                                        <div className="stat-block-column items-end">
                                            <span className="stat-label flex items-center gap-2">
                                                SENSOR <Radio size={24} className="text-primary" />
                                            </span>
            ...
            <div className={`game-sidebar ${isSidebarCollapsed ? 'collapsed overflow-visible' : 'overflow-x-hidden overflow-y-auto'}`}>
                ...
                <div className={`flex flex-col gap-[clamp(0.75rem,1.5vh,1.5rem)] min-w-[280px] w-full h-full transition-opacity duration-200 shrink-0 ${isSidebarCollapsed ? 'opacity-0 h-0 hidden' : 'opacity-100'}`}>
                    ...
                    <div className="flex items-center justify-start px-2 py-1 shrink-0">
                        <button
                            onClick={() => setIsSidebarCollapsed(true)}
                            className="p-2 hover:bg-white/10 rounded-full transition-colors flex items-center justify-center group"
                            title="Collapse Sidebar"
                        >
                            <Menu size={34} className="text-primary group-hover:scale-110 transition-transform" />
                        </button>
                    </div>
