...
const MusicView = ({ result }) => {
  ...
  return (
    <div className="eeg-view-container" style={{display: 'flex', flexDirection: 'column', height: '100%', position: 'relative'}}>
      ...
      <div className="eeg-status-box" style={{borderColor: `${stateTheme.primary}40`, background: 'rgba(0,0,0,0.4)', position: 'relative', overflow: 'hidden'}}>
