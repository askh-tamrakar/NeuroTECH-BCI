...
<<<<<<<< HEAD:backend/core/acquisition/stream_manager.py
from core.acquisition.lsl_streams import LSLStreamer, LSL_AVAILABLE
========
from src.acquisition.lsl_streams import LSLStreamer, LSL_AVAILABLE
from src.utils.config import config_manager
>>>>>>>> extra-features:backend/src/acquisition/stream_manager.py
